...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "RAGUNATH R");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212222240081");
        HAL_Delay(500);
  while (1)
  {
...
![image](https://github.com/Vasanthpushpa/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119291100/017a6791-d09a-4676-8192-262339b27c61)
